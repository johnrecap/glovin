        ...
        <div class="db-card-body">
            <form @submit.prevent="save">
                <div class="form-row">
                    ...
                    <div class="form-col-12 sm:form-col-6">
                        <label class="db-field-title required" for="left">
                    ...
                    <div class="form-col-12 sm:form-col-6">
                        <label class="db-field-title required" for="online_payment_gateway_enable">{{
                            $t("label.online_payment_gateway") }}</label>
                        <div class="db-field-radio-group">
                            <div class="db-field-radio">
                                <div class="custom-radio">
                    ...
                    <div class="form-col-12 sm:form-col-6">
                        <label class="db-field-title required" for="pick_up_enable">{{ $t("label.pick_up") }}</label>
                        <div class="db-field-radio-group">
                            <div class="db-field-radio">
                                <div class="custom-radio">
                                    <input :value="enums.activityEnum.ENABLE" v-model="form.site_pick_up"
                                        id="pick_up_enable" type="radio" class="custom-radio-field" />
                                    <span class="custom-radio-span"></span>
                                </div>
                                <label for="pick_up_enable" class="db-field-label">
                                    {{ $t("label.enable") }}
                                </label>
                            </div>
                            <div class="db-field-radio">
                                <div class="custom-radio">
                                    <input :value="enums.activityEnum.DISABLE" v-model="form.site_pick_up" type="radio"
                                        id="pick_up_disable" class="custom-radio-field" />
                                    <span class="custom-radio-span"></span>
                                </div>
                                <label for="pick_up_disable" class="db-field-label">
                                    {{ $t("label.disable") }}
                                </label>
                            </div>
                        </div>
                        <small class="db-field-alert" v-if="errors.site_pick_up">
                            {{ errors.site_pick_up[0] }}
                        </small>
                    </div>

                    <div class="form-col-12 sm:form-col-6">
                        <label class="db-field-title required" for="email_verification_disable">{{
                            $t("label.email_verification") }}</label>
                        <div class="db-field-radio-group">
                            <div class="db-field-radio">
                                <div class="custom-radio">
                    ...
                    <div class="form-col-12 sm:form-col-6">
                        <label class="db-field-title required" for="phone_verification_disable">{{
                    ...
                    <div class="form-col-12 sm:form-col-6">
                        <label class="db-field-title required" for="debug_disable">{{ $t("label.app_debug") }}</label>
                        <div class="db-field-radio-group">
                            <div class="db-field-radio">
                                <div class="custom-radio">
