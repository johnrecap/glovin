...
class ProductCategory extends Model implements HasMedia
{
    ...
    {
        $this->addMediaConversion('thumb')->fit('contain', 168, 122)->keepOriginalImageFormat()->sharpen(10);
        $this->addMediaConversion('cover')->fit('contain', 640, 960)->keepOriginalImageFormat()->sharpen(10);
    }
