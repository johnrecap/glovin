...
class Product extends Model implements HasMedia
{
    ...
    {
        $this->addMediaConversion('thumb')->fit('contain', 112, 120)->keepOriginalImageFormat()->sharpen(10);
        $this->addMediaConversion('cover')->fit('contain', 240, 250)->keepOriginalImageFormat()->sharpen(10);
