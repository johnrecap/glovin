...
return [
    'label'   => [
        ...
        'apartment_and_flat'         => 'Apartment / Floor Number',
        'select_governorate'         => 'Select Governorate',
        'enter_city'                 => 'Enter city or district',
        'enter_street'               => 'Enter street name',
        'enter_building_number'      => 'Enter building number',
        'enter_apartment'            => 'Example: Apartment 5, 3rd Floor',
        'confirm_address'            => 'Confirm Address',
        'your_address'               => 'Your Address',
        'full_address'               => 'Full Address',
        'enter_full_address'         => 'Enter full address (Area - Street - Nearest Landmark)',
        'use_map'                    => 'Use Map',
    ...
    'message' => [
        ...
        'attribute_invalid'                => 'This attribute is invalid. Create attribute option first.',
